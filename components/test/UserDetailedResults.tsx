...
interface UserDetailedResultsProps {
  onBackToDashboard: () => void;
}

export const UserDetailedResults: React.FC<UserDetailedResultsProps> = ({ onBackToDashboard }) => {
  const { user } = useAuth();
  ...
  const analyzeResults = useCallback(async () => {
    ...
    try {
      ...
      const { result: analyzedResult, error } = await RangeAnalysisService.analyzeTestResults(user.id);
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-slate-700 font-semibold text-lg">Analyzing your test results...</p>
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-slate-600 mt-2">Unable to load your test results</p>
          <Button onClick={onBackToDashboard} variant="outline" className="mt-4">
            Back to Dashboard
          </Button>
        </div>
      </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <div>
              ...
              <p className="text-gray-600">Task Maturity Assessment Analysis</p>
            </div>
            <Button onClick={onBackToDashboard} variant="outline">
              Back to Dashboard
            </Button>
          ...
          <div className="p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-6 rounded-xl border border-blue-200 shadow-sm">
                ...
                <p className="text-4xl font-bold text-blue-800 mb-2">{detailedResult.totalScore}/{detailedResult.maxPossibleScore}</p>
              ...
              <div className="bg-gradient-to-br from-violet-50 to-violet-100 p-6 rounded-xl border border-violet-200 shadow-sm">
                ...
                <p className="text-4xl font-bold text-violet-800 mb-2">{detailedResult.completionRate}%</p>
            ...
            <div className="space-y-6">
              <h3 className="text-2xl font-bold text-slate-900 mb-6">Your Dimension Analysis</h3>
              ...
              {detailedResult.dimensionResults.map((dimension, index) => (
                <div key={index} className="bg-white border border-slate-200 rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow duration-200">
                  ...
                  <div className="bg-slate-50 p-5 rounded-xl border border-slate-200">
                    <h5 className="font-bold text-slate-900 mb-3 text-lg">Your Performance:</h5>
            ...
            <div className="mt-8 flex justify-center">
              <Button onClick={onBackToDashboard} className="bg-indigo-600 hover:bg-indigo-700 text-white px-8 py-3 text-lg">
                Back to Dashboard
              </Button>
            </div>
          </div>
